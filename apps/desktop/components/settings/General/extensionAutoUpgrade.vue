...
<template>
	<div class="grid grid-cols-2 gap-4">
		<span class="justify-self-end">{{ $t("settings.general.extension-upgrade") }}</span>
		<div class="flex items-center space-x-2">
			...
			>
				{{ $t(appConfig.extensionAutoUpgrade ? "settings.general.extension-upgrade.auto" : "settings.general.extension-upgrade.manual") }}
			</label>
		</div>
	</div>
</template>
