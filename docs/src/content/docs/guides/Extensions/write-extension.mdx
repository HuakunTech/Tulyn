...
For now, KK doesn't have a website like Raycast for extensions. I will implement a simple store in the near future.

Currently, for security reason, extensions are expected to be open sourced. 

For now, for simplicity, you can fork [`KunkunExtensions`](https://github.com/kunkunsh/KunkunExtensions) repo and send a PR to add your extension. 

Once your PR is merged, your extension will be compiled in CI within a isolated environment with docker and uploaded to the store.
